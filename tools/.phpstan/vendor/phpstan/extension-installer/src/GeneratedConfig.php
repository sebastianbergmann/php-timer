...
final class GeneratedConfig
{
  ...
  array (
    'install_path' => '/usr/local/src/php-timer/tools/.phpstan/vendor/ergebnis/phpstan-rules',
  ...
  array (
    'install_path' => '/usr/local/src/php-timer/tools/.phpstan/vendor/phpstan/phpstan-strict-rules',
  ...
  array (
    'install_path' => '/usr/local/src/php-timer/tools/.phpstan/vendor/tomasvotruba/type-coverage',
